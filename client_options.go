...
// ClientOption is a functional option for extending a Hrpc client.
type ClientOption func(*ClientOptions)

// WithClientHooks defines the hooks for a Hrpc client.
...
// WithClientInterceptors defines the interceptors for a Hrpc client.
...
// WithClientLiteralURLs configures the Hrpc client to use the exact values
// as defined in the proto file for Service and Method names, which is manifested
// when working with Hrpc services implemented other languages (e.g. Python) and the proto file definitions
...
// Hrpc-generated client. These callbacks all accept a context and some return
...
// each outgoing request from the Hrpc client. The last hook to be called
...
type ClientHooks struct {
	...
	// it has been sent to the Hrpc server.
...
// ClientOptions encapsulate the configurable parameters on a Hrpc client.
