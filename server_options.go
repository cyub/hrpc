...
// ServerOption is a functional option for extending a Hrpc service.
type ServerOption func(*ServerOptions)

// WithServerHooks defines the hooks for a Hrpc server.
...
// WithServerInterceptors defines the interceptors for a Hrpc server.
...
// If not specified, the "/hrpc" prefix is used by default.
...
// proto field names. Hrpc uses the original proto field names by default,
...
// Hrpc-generated server. These callbacks all accept a context and return a
...
// request that the Hrpc server handles. The last hook to be called in a
...
type ServerHooks struct {
	// RequestReceived is called as soon as a request enters the Hrpc
	...
	// particular method of the Hrpc server.
...
// ServerOptions encapsulate the configurable parameters on a Hrpc server.
...
type ServerOptions struct {
	...
	// generated by older versions of Hrpc (before v8.1.0).
